...
export default function Footer() {
    return (
        <footer className="relative mt-20 pt-16 pb-8 border-t border-gray-200/50 bg-white/30 backdrop-blur-xl overflow-hidden">
            {/* Decorative Top Line */}
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 relative z-10">
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm hover:shadow-md">
            ...
            <div className="max-w-7xl mx-auto px-6 border-t border-gray-200/50 pt-8 flex flex-col md:flex-row justify-between items-center relative z-10 gap-4">
            ...
            {/* Background blur effects to match website theme */}
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-100/50 blur-[120px] pointer-events-none -z-10 rounded-full"></div>
        </footer>
    )
}