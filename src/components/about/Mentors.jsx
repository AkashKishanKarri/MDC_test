...
export default function Mentors() {
    const mentors = [
        { name: "Mentor Name", role: "Faculty Advisor", img: "/mentors/mentor1.jpg", linkedin: "https://linkedin.com/in/", email: "mentor1@example.com" },
        { name: "Mentor Name", role: "Industry Expert", img: "/mentors/mentor2.jpg", linkedin: "https://linkedin.com/in/", email: "mentor2@example.com" },
        { name: "Mentor Name", role: "Alumni", img: "/mentors/mentor3.jpg", linkedin: "https://linkedin.com/in/", email: "mentor3@example.com" },
    ]
                        ...
                        <div className="relative bg-white border border-gray-100 rounded-3xl p-6 text-center overflow-hidden h-full shadow-lg">
                            ...
                            <div className="relative w-32 h-32 mx-auto mb-6 rounded-full p-1 bg-gradient-to-br from-indigo-400 to-purple-600">
                                <img
                                    ...
                                    onError={(e) => {
                                        e.target.src = `https://ui-avatars.com/api/?name=${mentor.name.split(' ')[0]}&background=f3f4f6&color=4f46e5&size=150`
                                    }}
                                />
                            </div>
