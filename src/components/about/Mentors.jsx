...
export default function Mentors() {
    const mentors = [
        { name: "Mentor Name", role: "Faculty Advisor", img: "/mentors/mentor1.jpg" },
        { name: "Mentor Name", role: "Industry Expert", img: "/mentors/mentor2.jpg" },
        { name: "Mentor Name", role: "Alumni", img: "/mentors/mentor3.jpg" },
    ]
